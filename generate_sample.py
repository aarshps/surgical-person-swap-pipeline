...
payload = {
    ...
    "steps": 1,  # Minimum steps for a fast test sample
    "width": 256, # Smaller resolution for speed
    "height": 256
}

print("Requesting image generation (this should be fast)...")
...
if response.status_code == 200:
    ...
    if 'images' in data and len(data['images']) > 0:
        ...
        output_path = "samples/sample_eagle.png"
